...
public class ModalidadController {
	...
	@GetMapping("/porSedePorIdDeporteJson")
	@ResponseBody
	public ResponseEntity<Map<String, Object>> listaSedePorIdDeporteConParametros(
							@RequestBody FiltroModalidad filtro) {
		
		Map<String, Object> salida = new HashMap<String, Object>();
		try {
			filtro.setNombre("%"+filtro.getNombre()+"%");
			List<Modalidad> lista = modalidadService.listaPorFiltroModalidad(filtro);
